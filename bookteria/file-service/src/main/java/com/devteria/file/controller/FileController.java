...
public class FileController {
    ...
    ResponseEntity<Resource> downloaddMedia (@PathVariable String fileName) throws IOException {
        var fileData = fileService.download(fileName);
        return ResponseEntity.<Resource>ok()
                // dòng này để trả ra ảnh chứ không phải data
                .header(HttpHeaders.CONTENT_TYPE, fileData.contenType())
